...
| Area | Checks |
| --- | --- |
| Inventory | There are 78 `research/tools/check-*.py` files, including this checker and key adjacent checkers. |
...
```text
OK research drift CI gate checks passed (78 checkers, 10 scenarios)
```
