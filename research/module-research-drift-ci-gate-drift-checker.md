...
| Area | Checks |
| --- | --- |
| Inventory | There are 80 `research/tools/check-*.py` files, including this checker and key adjacent checkers. |
...
```text
OK research drift CI gate checks passed (80 checkers, 10 scenarios)
```
