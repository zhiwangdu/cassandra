...
| Area | Checks |
| --- | --- |
| Inventory | There are 75 `research/tools/check-*.py` files, including this checker and key adjacent checkers. |
...
```text
OK research drift CI gate checks passed (75 checkers, 10 scenarios)
```
