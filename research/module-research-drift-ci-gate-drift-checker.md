...
| Area | Checks |
| --- | --- |
| Inventory | There are 76 `research/tools/check-*.py` files, including this checker and key adjacent checkers. |
...
```text
OK research drift CI gate checks passed (76 checkers, 10 scenarios)
```
