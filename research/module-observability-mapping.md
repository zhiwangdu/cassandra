...
- nodetool metrics reads：`Info` 直接读取 cache/buffer/storage/table metrics，`ProxyHistograms` 读取 StorageProxy client request timer，`TableHistograms` 读取 CFS histogram/timer，见 `src/java/org/apache/cassandra/tools/nodetool/Info.java:89-165`、`src/java/org/apache/cassandra/tools/nodetool/ProxyHistograms.java:32-50`、`src/java/org/apache/cassandra/tools/nodetool/TableHistograms.java:50-166`。
