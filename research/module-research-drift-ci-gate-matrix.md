...
| `research_checker_adjacency_runbook_contract` | 模块文档中提到的相邻 checker 仍按模块运行，例如 testing CI generator、nodetool、nodetool cache runtime、nodetool snapshot lifecycle、MV build status、MV paired replica、QueryProcessor execution、read warning/abort thresholds、row-index read-size thresholds、JMX compatibility 和 guardrails checker。 | `research/tools/check-testing-ci-generator-drift.py:246`, `research/tools/check-nodetool-runbook-drift.py:135`, `research/tools/check-nodetool-cache-runtime-drift.py:3`, `research/tools/check-nodetool-snapshot-lifecycle-drift.py:3`, `research/tools/check-materialized-view-build-status-drift.py:3`, `research/tools/check-materialized-view-paired-replica-drift.py:3`, `research/tools/check-query-processor-execution-drift.py:3`, `research/tools/check-read-warning-abort-thresholds-drift.py:3`, `research/tools/check-row-index-read-size-thresholds-drift.py:3`, `research/tools/check-jmx-compatibility-drift.py:14` | 修改 CI/JMX/nodetool/guardrails/MV build/paired replica/QueryProcessor/read warning/row-index 相关源码时，应跑本矩阵 checker 加相邻模块 checker。 |
